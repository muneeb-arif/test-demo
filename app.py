...
# Get API key from environment variable (for Vercel) or Streamlit secrets (for local)
api_key = os.getenv("OPENAI_API_KEY") or st.secrets.get("OPENAI_API_KEY", "")
if not api_key:
    st.error("OPENAI_API_KEY not found. Please set it in Vercel environment variables.")
    st.stop()
